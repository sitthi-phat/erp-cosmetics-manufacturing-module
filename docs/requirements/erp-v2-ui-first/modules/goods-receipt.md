...
| หน้าจอ | บทบาท |
|---|---|
| `goods-receipt.html` | รับเข้า multi-line: supplier→auto lot prefix, จำนวน, ราคาซื้อ, เลขใบรับจาก supplier, upload, อ้าง PR |
...
|---|---|
| ดู GR / list | Warehouse/Stock.**Read (R)** |
