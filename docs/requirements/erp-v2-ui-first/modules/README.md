...
> **สรุปสถานะ:** ทุกรายการ **settled → READY_FOR_UX_UI**. รอบล่าสุด = **G9 permission-code suffix** (register convention + authoritative action→code map) — ripples: `permission-matrix.md` (§1/§1b/§3/§4/§5) · README (§3 G9 · §8 sweep · §7 changelog · Thai summary). ก่อนหน้า: (1) Return RM selector + list search · (2) G8 number-on-save.
