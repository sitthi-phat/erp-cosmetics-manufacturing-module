...
The CANONICAL, up-to-date spec is the **per-module package**; design screens against it, not older docs:
...
- Screens you own (mockups = the approved look): `docs/design/erp-v2-ui-first/mockups/`.
